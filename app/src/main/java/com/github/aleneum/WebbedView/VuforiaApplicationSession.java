...
public class VuforiaApplicationSession implements UpdateCallbackInterface
{
    ...
    private final WeakReference<VuforiaApplicationControl> mSessionControlRef;
    
    // Vuforia Engine status flags
    private boolean mStarted = false;
    private boolean mCameraRunning = false;

    private int mVideoMode = CameraDevice.MODE.MODE_OPTIMIZE_QUALITY;
